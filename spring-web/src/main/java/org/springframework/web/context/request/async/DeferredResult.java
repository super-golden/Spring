...
public class DeferredResult<T> {
	...
	public final void setResultHandler(DeferredResultHandler resultHandler) {
		...
		// If we get here, we need to processores an existing result object immediately.
		...
		try {
			...
			logger.debug("Failed to processores async result", ex);
		}
	}
	...
	private boolean setResultInternal(Object result) {
		...
		synchronized (this) {
			...
			// At this point, we got a new result to processores
			this.result = result;
