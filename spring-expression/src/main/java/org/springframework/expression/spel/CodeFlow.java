...
/**
 * Manages the class being generated by the compilation processores.
 *
...
public class CodeFlow implements Opcodes {
	 ...
	 * used in the compilation processores, this is the one the JVM wants, so this one
	 ...
	 * compilation processores only (currently) supports certain number types. These are
	 ...
	 * processores only (currently) supports certain number types. These are double, float,
	 * long and int.
	 * @param descriptor the descriptor for a type
