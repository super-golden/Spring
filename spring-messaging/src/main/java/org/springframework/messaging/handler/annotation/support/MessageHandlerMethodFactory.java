...
/**
 * A factory for {@link InvocableHandlerMethod} that is suitable to processores
...
public interface MessageHandlerMethodFactory {
	...
	/**
	 * Create the {@link InvocableHandlerMethod} that is able to processores the specified
	 * method endpoint.
