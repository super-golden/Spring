...
public class PropertyValue extends BeanMetadataAttributeAccessor implements Serializable {
	...
	/** Package-visible field that indicates whether conversion is necessary. 指示是否需要转换的包可见字段。*/
	@Nullable
	volatile Boolean conversionNecessary;

	/** Package-visible field for caching the resolved property path tokens.包可见字段，用于缓存已解析的属性路径tokens。 */
	@Nullable
