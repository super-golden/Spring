...
/*
XmlBeanFactory 对 DefaultListableBeanFactory类进行了扩展，主要用于从XML文档中读取Bean
 Definition ，对于注册及获取Bean都是使用父类DefaultListableBeanFactory 继承的方法去实现。
...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	 ...
	 * @param resource the XML resource to load bean definitions from 从中加载bean定义的XML资源
