...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** Package-visible field for caching the resolved constructor or factory method.包可见字段，用于缓存已解析的构造函数或工厂方法。 */
	@Nullable
	...
	/** Package-visible field that indicates MergedBeanDefinitionPostProcessor having been applied.指示已应用MergedBeanDefinitionPostProcessor的包可见字段。 */
