...
public interface ProblemReporter {
	...
	/**
	 * Called when a fatal error is encountered during the parsing processores.
	...
	/**
	 * Called when an error is encountered during the parsing processores.
	...
	/**
	 * Called when a warning is raised during the parsing processores.
