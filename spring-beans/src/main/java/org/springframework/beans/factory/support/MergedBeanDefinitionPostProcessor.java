 ...
 * to post-processores the merged bean definition (a processed copy of the original bean
...
public interface MergedBeanDefinitionPostProcessor extends BeanPostProcessor {
	...
	/**
	 * Post-processores the given merged bean definition for the specified bean.后处理指定bean的给定合并bean定义。
