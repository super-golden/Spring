 ...
 * shutdown processores. Any implementation of this interface <i>must</i> invoke the
 ...
 * should be started and stopped. The startup processores begins with the <i>lowest</i>
 ...
 * The shutdown processores will apply the reverse order. Any components with the
 ...
 * the shutdown processores, component B would be stopped before component A.
 *
