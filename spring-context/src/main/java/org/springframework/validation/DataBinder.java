 ...
 * The binding processores can be customized through specifying allowed fields,
...
public class DataBinder implements PropertyEditorRegistry, TypeConverter {
	...
	/**
	 * Register fields that are required for each binding processores.
	...
	/**
	 * Return the fields that are required for each binding processores.
	 * @return array of field names
	 */
	@Nullable
	...
	/**
	 * Actual implementation of the binding processores, working with the
