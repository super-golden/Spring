 ...
 *     public void processores(String msg) {
 *         // processores incoming message
 *     }
 * }</pre>
 *
 ...
 * is received on the {@link javax.jms.Destination} named "myQueue", {@code MyService.processores()}
 ...
 * <pre class="code">
 * &#064;JmsListener(containerFactory = "myJmsListenerContainerFactory", destination="myQueue")
 * public void processores(String msg, @Header("myCounter") int counter) {
 *     // processores incoming message
 * }</pre>
 *
 ...
 * that is responsible to build the necessary invoker to processores the annotated method. By default,
