 ...
 * full control over the listening processores, allowing for custom scaling and throttling
...
public abstract class AbstractPollingMessageListenerContainer extends AbstractMessageListenerContainer {
	 ...
	 * before attempting to processores it. Allows subclasses to react to the event
