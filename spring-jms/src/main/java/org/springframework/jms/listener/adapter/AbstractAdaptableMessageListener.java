...
public abstract class AbstractAdaptableMessageListener
	...
	/**
	 * Pre-processores the given result before it is converted to a {@link Message}.
	...
	/**
	 * Post-processores the given response message before it will be sent.
	...
	/**
	 * Post-processores the given message producer before using it to send the response.
